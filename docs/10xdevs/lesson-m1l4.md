...
> Wyniesione z `CLAUDE.md` 2026-08-24. Dokumentuje łańcuch skilli 10xDevs, nie ten
> projekt — dlatego nie należy do pliku reguł ładowanego w każdej sesji.
> Oryginał: `git show HEAD:CLAUDE.md`.
