-- KROK 1 — WDROZENIE S-11 NA PRODUKCJE.
--
-- WKLEJ DOPIERO, GDY KROK 0 POWIEDZIAL „OK — mozna wklejac krok 1".
-- Jesli powiedzial „STOP", nie wklejaj: skrypt padnie na pierwszej instrukcji,
-- bo zaczyna sie od `drop function public.accounts_overview()`.
--
-- TRESC MIGRACJI JEST WKLEJONA Z PLIKU `supabase/migrations/20260914120000_account_blocking.sql`
-- BEZ ZMIAN. Jesli kiedykolwiek bedziesz porownywal, to musi byc ten sam tekst.
--
-- CALOSC W JEDNEJ TRANSAKCJI. Porazka w polowie wycofuje wszystko — w szczegolnosci
-- nie zostawia `accounts_overview()` upuszczonego i nieodtworzonego, co byloby
-- gorsze niz stan sprzed wdrozenia.
--
...
-- ============================================================================
--  ZABUKOWANIE WERSJI W REJESTRZE
--
--  Bez tego wpisu nastepny `supabase db push` uzna migracje za niewykonana
--  i zastosuje ja PONOWNIE — a `drop function` na poczatku sprawi, ze przez
--  moment nie bedzie przegladu kont.
--
--  `on conflict do nothing`, zeby powtorne uruchomienie calego skryptu nie
--  wywracalo sie na kluczu glownym.
-- ============================================================================

insert into supabase_migrations.schema_migrations (version, name)
values ('20260914120000', 'account_blocking')
