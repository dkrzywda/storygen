-- MUTACJA B — zdjety zakaz usuwania wlasnego konta.
-- Zmierzone: czerwieni przypadki 5-6. To jedyna bariera, ktora w tej funkcji
-- stoi w bazie, a nie w widoku, wiec jej brak nie objawia sie nigdzie indziej.
--
-- JAK URUCHOMIC (sklej z testem, w jednej sesji):
--
--   CID=$(docker ps --filter name=supabase_db --format "{{.ID}}")
--   cat context/changes/admin-delete-account/mutations/mut-b-bez-zakazu-siebie.sql \
...
begin
  ...
  -- ==========================================================================
  -- <<< ZAKAZ USUNIECIA SIEBIE USUNIETY >>>
