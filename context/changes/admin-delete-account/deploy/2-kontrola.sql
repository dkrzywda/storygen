-- KROK 2 — KONTROLA PRODUKCJI PO S-12.
--
-- WKLEJAJ GO OSOBNO, W NOWEJ SESJI. Kontrola w tej samej sesji co zmiana
-- potwierdza tylko to, co widzi ta sesja. Zasada przyjeta po tym, jak migracja
-- S-09 zniknela z produkcji przy commicie na miejscu i werdykcie OK — a
...
-- commitem wypisuje "Success. No rows returned", co nie odroznia sukcesu
-- od no-opu.
--
...
--
-- CZEGO TU CELOWO NIE MA: kolumny z pg_control_system().system_identifier,
-- ktora lokalny verify-deletion.sql ma jako mocniejszy wyroznik. Edytor SQL
-- dostawcy odrzucil ja bledem skladni 42601 (2026-09-14) i przyczyny nie
-- ustalono. Adres poolera jest slabszym wyroznikiem — wspolnym dla projektow
-- w regionie — wiec czytaj tozsamosc RAZEM z liczbami kont i generacji nizej.
--
